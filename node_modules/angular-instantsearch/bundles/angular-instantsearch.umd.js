(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('instantsearch.js/es/connectors'), require('algoliasearch/lite'), require('instantsearch.js/es'), require('instantsearch.js/es/widgets/index/index'), require('nouislider'), require('querystring-es3/encode')) :
    typeof define === 'function' && define.amd ? define('angular-instantsearch', ['exports', '@angular/core', '@angular/common', 'instantsearch.js/es/connectors', 'algoliasearch/lite', 'instantsearch.js/es', 'instantsearch.js/es/widgets/index/index', 'nouislider', 'querystring-es3/encode'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['angular-instantsearch'] = {}, global.ng.core, global.ng.common, global.instantsearch.connectors, global.algoliasearch, global.instantsearch, global.instantsearch.widgets.index, global.noUiSlider, global.qs.encode));
}(this, (function (exports, core, common, connectors, algoliasearchProxy, instantsearch, indexWidget, noUiSlider, encodeProxy) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TypedBaseWidget = /** @class */ (function () {
        ...
        TypedBaseWidget.prototype.createWidget = function (connector, options) {
    ...
    var NgAisIndex = /** @class */ (function () {
        ...
        NgAisIndex.prototype.createWidget = function () {
            this.widget = indexWidget__default['default']({
        ...
        Object.defineProperty(NgAisHighlight.prototype, "content", {
            get: function () {
                ...
                if (this.hit.hasOwnProperty('_highlightResult')) {
                    var attributeHighlighted = getPropertyByPath(this.hit._highlightResult, this.attribute);
                ...
                var fallback = getPropertyByPath(this.hit, this.attribute);
                if (!fallback) {
    ...
    exports.ɵx = NgAisConfigureRelatedItems;
    exports.ɵy = NgAisQueryRuleCustomData;
    exports.ɵz = NgAisQueryRuleContext;
