...
export declare class IgxComboDropDownComponent extends IgxDropDownComponent implements IDropDownBase, OnDestroy, AfterViewInit {
    ...
    constructor(elementRef: ElementRef, cdr: ChangeDetectorRef, platform: PlatformUtil, selection: IgxSelectionAPIService, combo: IgxComboBase, comboAPI: IgxComboAPIService, _displayDensityOptions: IDisplayDensityOptions);
    /**
     * @hidden @internal
     */
    onFocus(): void;
