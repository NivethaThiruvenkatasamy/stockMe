...
export declare class IgxAddRow extends IgxEditRow {
    ...
    grid: IgxGridBaseDirective & GridType;
    isAddRow: boolean;
    constructor(id: any, index: number, data: any, recordRef: any, grid: IgxGridBaseDirective & GridType);
    createEditEventArgs(includeNewValue?: boolean, event?: Event): IGridEditEventArgs;
    createDoneEditEventArgs(cachedRowData: any, event?: Event): IGridEditDoneEventArgs;
}
...
export declare class IgxRowAddCrudState extends IgxRowCrudState {
     ...
     * @hidden @internal
     */
    createAddRow(parentRow: IgxRowDirective<IgxGridBaseDirective & GridType>, asChild?: boolean): IgxAddRow;
    /**
     * @hidden @internal
     */
    createAddRowParent(row: IgxRowDirective<IgxGridBaseDirective & GridType>, newRowAsChild?: boolean): void;
    /**
     * @hidden @internal
     */
    endRowTransaction(commit: boolean, event?: Event): IGridEditEventArgs;
...
export declare class IgxGridCRUDService extends IgxRowAddCrudState {
     ...
     */
    enterAddRowMode(parentRow: IgxRowDirective<IgxGridBaseDirective & GridType>, asChild?: boolean, event?: Event): void;
    /**
