...
export declare class IgxGridRow extends BaseRow implements RowType {
     ...
     * @hidden
     */
    constructor(grid: IgxGridComponent, index: number, data?: any);
    /**
     * Returns the view index calculated per the grid page.
     */
    get viewIndex(): number;
...
export declare class IgxTreeGridRow extends BaseRow implements RowType {
     ...
     * @hidden
     */
    constructor(grid: IgxTreeGridComponent, index: number, data?: any, _treeRow?: ITreeGridRecord);
    /**
     * Returns the view index calculated per the grid page.
     */
    get viewIndex(): number;
...
export declare class IgxHierarchicalGridRow extends BaseRow implements RowType {
     ...
     * @hidden
     */
    constructor(grid: IgxHierarchicalGridComponent, index: number, data?: any);
    /**
...
export declare class IgxSummaryRow implements RowType {
     ...
     * @hidden
     */
    constructor(grid: IgxGridComponent | IgxTreeGridComponent | IgxHierarchicalGridComponent, index: number, _summaries?: Map<string, IgxSummaryResult[]>, type?: GridInstanceType);
    private getRootParent;
}
export {};
