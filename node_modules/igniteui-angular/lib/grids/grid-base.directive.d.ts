...
export declare abstract class IgxGridBaseDirective extends DisplayDensityBase implements GridType, OnInit, DoCheck, OnDestroy, AfterContentInit, AfterViewInit {
    ...
    get filteringRow(): import("./filtering/base/grid-filtering-row.component").IgxGridFilteringRowComponent;
    /** @hidden @internal */
    theadRow: IgxGridHeaderRowComponent;
    /** @hidden @internal */
    groupByArea: IgxGridGroupByAreaComponent;
    /**
     * @hidden @internal
     */
    tbody: ElementRef;
     ...
     * ```
     */
    get headerCellList(): import("./headers/grid-header.component").IgxGridHeaderComponent[];
    /**
     ...
     * @hidden @internal
     */
    get columnInDrag(): IgxColumnComponent;
    constructor(selectionService: IgxGridSelectionService, colResizingService: IgxColumnResizingService, gridAPI: GridBaseAPIService<IgxGridBaseDirective & GridType>, transactionFactory: IgxFlatTransactionFactory, elementRef: ElementRef<HTMLElement>, zone: NgZone, document: any, cdr: ChangeDetectorRef, resolver: ComponentFactoryResolver, differs: IterableDiffers, viewRef: ViewContainerRef, navigation: IgxGridNavigationService, filteringService: IgxFilteringService, overlayService: IgxOverlayService, summaryService: IgxGridSummaryService, _displayDensityOptions: IDisplayDensityOptions, localeId: string, platform: PlatformUtil, _diTransactions?: TransactionService<Transaction, State>);
    /**
     * @hidden
     * @internal
     */
     ...
     * @hidden @internal
     */
    getEmptyRecordObjectFor(inRow: IgxRowDirective<IgxGridBaseDirective & GridType>): {
        rowID: string | number;
        data: any;
        recordRef: any;
    };
