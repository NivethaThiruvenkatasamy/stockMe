import { OnInit, TemplateRef, QueryList, AfterContentInit, DoCheck, AfterViewInit, ElementRef, NgZone, ChangeDetectorRef, ComponentFactoryResolver, IterableDiffers, ViewContainerRef } from '@angular/core';
...
export declare class IgxTreeGridComponent extends IgxGridBaseDirective implements GridType, OnInit, AfterViewInit, DoCheck, AfterContentInit {
     ...
     * @hidden @internal
     */
    getEmptyRecordObjectFor(inTreeRow: any): {
        rowID: string | number;
        data: any;
        recordRef: any;
    };
