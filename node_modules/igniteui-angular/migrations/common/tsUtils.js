...
var SynaxTokens;
(function (SynaxTokens) {
    SynaxTokens["ClosingParenthesis"] = ")";
    SynaxTokens["MemberAccess"] = ".";
    SynaxTokens["Question"] = "?";
})(SynaxTokens || (SynaxTokens = {}));
...
const isMemberIgniteUI = (change, langServ, entryPath, matchPosition) => {
    ...
    const typeDef = exports.getTypeDefinitionAtPosition(langServ, entryPath, matchPosition);
    if (!typeDef) {
        return false;
    }
...
const getMethodTypeDefinition = (langServ, definition) => {
    ...
    if (((_b = (_a = returnType.symbol) === null || _a === void 0 ? void 0 : _a.declarations) === null || _b === void 0 ? void 0 : _b.length) > 0) {
