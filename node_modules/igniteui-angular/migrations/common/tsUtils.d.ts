 ...
 */
export declare const getTypeDefinitionAtPosition: (langServ: tss.LanguageService, entryPath: string, position: number) => Pick<tss.DefinitionInfo, 'name' | 'fileName'> | null;
/**
